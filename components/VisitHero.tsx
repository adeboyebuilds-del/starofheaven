...
export default function VisitHero() {
  return (
    <section className="relative flex min-h-[70vh] items-center justify-center overflow-hidden bg-navy-950 text-cream">
      {/* Background image — replace src with a wide exterior/campus photo */}
      <div className="absolute inset-0">
        <Image
          src="/images/visit/hero.jpg"
          alt="Church exterior at golden hour"
          fill
          priority
      ...
      <div className="relative z-20 mx-auto flex w-full max-w-8xl flex-col items-center px-6 py-24 text-center">
        ...
        <p className="eyebrow-inverse mt-5 text-sm sm:text-base">
          Everything You Need to Feel at Home
        </p>
        <Link
          href="/community"
          className="mt-9 inline-block rounded-sm border border-cream/50 px-8 py-3 text-sm font-semibold text-cream transition hover:border-cream hover:bg-cream/10"
        >
          Explore
        </Link>
      </div>
